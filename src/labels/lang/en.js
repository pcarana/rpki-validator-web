const messages = {
  ...
  repositories: {
    ...
    syncSuccess: 'Finished synchronization'
  },
  repository: {
    title: 'TAL detail',
    general: {
    ...
    files: {
      ...
      error: 'Error',
      total: 'Total',
      noData: 'The repository doesn\'t have recent validation data or is currently being validated, try accessing this module in a moment'
    },
    validations: {
  ...
  common: {
    ...
    syncRunning: 'The synchronization was already requested, wait until it ends its execution.',
    loading: 'Loading...',
    element: 'Element #{n}',
